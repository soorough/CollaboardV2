...
export const TopNavBar = () => {
  return (
    <header className="absolute self-stretch flex flex-row items-center justify-between pt-0 pb-px pr-5 pl-[13px] box-border top-[0] z-[99] gap-[20px] w-full text-left text-lgi text-white font-open-sans">
