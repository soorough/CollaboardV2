...
const MainDrawingScreen: NextPage = () => {
  return (
    <section className="w-full my-0 mx-[!important] absolute h-full top-[0px] right-[0px] bottom-[0px] left-[0px] flex flex-row items-center justify-center max-w-full z-[1] text-center text-127xl text-dimgray font-londrina-shadow">
